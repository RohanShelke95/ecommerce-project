  ...
  return (
    ...
    {showNavigation && <Navigation />}
     ...
     <Route path="/register" element={<Homepage />}></Route>
        ...
        <Route path="/account/order" element={<ProtectedRoute><Order /></ProtectedRoute>}></Route>
        <Route path="/account/order/:orderId" element={<ProtectedRoute><OrderDetails /></ProtectedRoute>}></Route>
        <Route path="/account/rate/:productId" element={<ProtectedRoute><RateProduct /></ProtectedRoute>}></Route>
        <Route path="/checkout" element={<ProtectedRoute><Checkout /></ProtectedRoute>}></Route>
        <Route path="/payment/:orderId" element={<ProtectedRoute><PaymentSuccess /></ProtectedRoute>}></Route>
