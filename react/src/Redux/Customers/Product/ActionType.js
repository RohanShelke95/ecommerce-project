...
export const SEARCH_PRODUCTS_PAGE_REQUEST = "SEARCH_PRODUCTS_PAGE_REQUEST";
export const SEARCH_PRODUCTS_PAGE_SUCCESS = "SEARCH_PRODUCTS_PAGE_SUCCESS";
export const SEARCH_PRODUCTS_PAGE_FAILURE = "SEARCH_PRODUCTS_PAGE_FAILURE";
